...
class LinearWarmupCosineAnnealingLR(torch.optim.lr_scheduler._LRScheduler):
    ...
    def get_lr(self):
        ...
        if self.last_epoch < self.warmup_epochs:
            return [
                group["lr"] + (base_lr - self.warmup_start_lr_factor * base_lr) / (self.warmup_epochs - 1)
    ...
    def _get_closed_form_lr(self):
        ...
        if self.last_epoch < self.warmup_epochs:
            return [
                self.warmup_start_lr_factor * base_lr + self.last_epoch * (base_lr - self.warmup_start_lr_factor * base_lr) / (self.warmup_epochs - 1)
